...
#[derive(Debug)]
pub struct NodemonDevProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodemonDevProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodemonDev processing");
    
    let mut processor = NodemonDevProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodemonDevProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodemonDevProcessor::new(false);
